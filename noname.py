...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_button4 = wx.Button( self, wx.ID_ANY, u"pause", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button2.Bind( wx.EVT_BUTTON, self.f_stop )
		self.m_button3.Bind( wx.EVT_BUTTON, self.f_start )
		self.m_button4.Bind( wx.EVT_BUTTON, self.f_pause )
	...
	def f_stop( self, event ):
		event.Skip()
	
	def f_start( self, event ):
		event.Skip()
	
	def f_pause( self, event ):
		event.Skip()
